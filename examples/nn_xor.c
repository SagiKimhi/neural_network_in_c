...
float
nn_xor_cost(nn_xor_t xor, nn_matrix_t t_in, nn_matrix_t t_out);
void
nn_xor_finite_difference(
    nn_xor_t xor,
    nn_xor_t gradient,
    float eps,
    nn_matrix_t t_in,
    nn_matrix_t t_out);
void
nn_xor_learn(nn_xor_t xor, nn_xor_t gradient, float rate);
